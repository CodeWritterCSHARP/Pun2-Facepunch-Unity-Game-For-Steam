...
public class GroundFall : MonoBehaviourPun
{
    [SerializeField] private AudioClip sound;

    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.gameObject.layer == 8 || collision.gameObject.CompareTag("Wheel"))
            this.photonView.RPC("Activate", RpcTarget.All);
    }
