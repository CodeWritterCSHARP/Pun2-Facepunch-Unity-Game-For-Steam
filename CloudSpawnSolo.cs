...
public class CloudSpawnSolo : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (timer <= 0)
        {
            ...
            GameObject cloud = Instantiate(clouds[i], spawnVector, Quaternion.identity);
            ...
            cloud.GetComponent<SoloDestroy>().TimeGetSet = Random.Range(liteTimeMin, liteTimeMax);
        }
    }
}
